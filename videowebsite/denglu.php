...
<link type="text/css" rel="stylesheet" href="style/denglu.css">
...
$result = mysql_query("SELECT password FROM zhuce
WHERE user='$_POST[dluser]'");
$row = mysql_fetch_row($result);
if($_POST[dlpassword]!=$row[0]){
		$passwd='密码错误！';
};
if($_POST[dlpassword]==$row[0]&&$row[0]!=""){
...
<!--<article id="article1">
    ...
    <div class="a_bottom">
     	<form id="zc" action="php/zhuce.php" method="post" target="_self">
     		<div>
            <img src="images/zuce/user.png"><input type="text"   placeholder="请输入用户名" id="zcuser" name="zcuser"><b>内容不能为空</b><b>输入6-16个字符字母数字或下划线</b>
            </div>
        	<div>
    ...
    <div class="a_bottom">
        <div class="dl_r">
     	<form  action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
     		<div >
            <img src="images/zuce/user.png"><input type="text"  id="u" placeholder="请输入用户名" id="dluser" name="dluser">
            </div>

            <div>
            <img src="images/zuce/password1.png"><input type="password"  id="p1" placeholder="请输入密码"  id="dlpassword" name="dlpassword">
            </div>

            <div>
           <!-- <img src="images/zuce/text.png"><input type="text"  placeholder="输入验证码" id="dltext" name="dltext"><input type="button" value="abcd" id="text_btn"  name="text_btn">-->
            <span style=" color:#F00;"><?php echo $passwd;?></span>
            </div>
            
            <input type="submit" value="登录" id="dltijiao"><!--<input type="submit" value="注册" id="zuce2">--><br/><br/>
